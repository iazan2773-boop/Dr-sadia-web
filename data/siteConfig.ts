export const siteConfig = {
  doctorName: "Dr. Sadia Ghufran",
  title: "Child Specialist",
  tagline:
    "Providing compassionate and expert healthcare for your little ones. Your child's health and well-being are our top priority.",
  closingLine: "Because every child deserves the best care.",
  whatsappNumber: "923332243012",
  credentials: [
    "MBBS",
    "MCPS",
    "PMDC Verified",
